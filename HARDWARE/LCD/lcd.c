...
void LCD_GPIOInit(void)
{
    ...
    GPIO_Initure.Pin=GPIO_PIN_9;            //PB9, for LED Background
    ...
    GPIO_Initure.Pin=GPIO_PIN_14| GPIO_PIN_15; //PD14 & PD15
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  //推挽输出
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    ...
    GPIO_Initure.Pin=GPIO_PIN_12;            //PF12
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  //推挽输出
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    GPIO_Initure.Speed=GPIO_SPEED_FREQ_HIGH;      //快速
...
{
    SPI1_Init();    //初始化SPI
    //SPI_SetSpeed(SPI_BAUDRATEPRESCALER_16); //设置为5M时钟,高速模式
